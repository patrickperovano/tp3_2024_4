# Exercicio
"""
A Cifra de César é uma técnica de criptografia simples em que cada letra de uma mensagem é substituída por outra letra que se encontra um número fixo de posições à frente no alfabeto. Por exemplo, se o deslocamento for 3, a letra 'A' se torna 'D', 'B' se torna 'E', etc. Quando se alcança o final do alfabeto, ele se reinicia (por exemplo, 'Z' se torna 'C' com um deslocamento de 3).
